...
[You can download it here.](<https://github.com/whoisryosuke/blender-midi-motion/tree/main/examples/MIDI Motion - 88 Key Collection - V2.blend>)
...
![Blender's Outliner with a collection called Piano Keys containing a list of objects named WhiteKey and BlackKey with note names appended to the end.](./assets/collection-mode-naming-example.png)
